    ...
    return (
        ...
        <div className='relative min-h-screen bg-[#050505] text-white overflow-hidden'>
            ...
            <div className="sticky top-0 z-40 backdrop-blur-xl bg-black/50 border-b border-white/10">
                ...
                <div className="max-w-7xl mx-auto  px-6 h-15 flex items-center">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <h1 className="text-lg font-semibold">Infinity Ai</h1>
            ...
            <div className='max-w-6xl mx-auto  px-6 py-16 relative z-10'>
                ...
                >
                    ...
                    <p className='text-zinc-400  max-w-2xl mx-auto'>
                        This process may take several minutes. Infinity Ai focuses on quality not shortcuts
                    </p>
                ...
                <div className='mb-7'>
                    ...
                    <div className='relative'>
                        ...
                        <textarea
                            ...
                            className='w-full h-40 p-5 rounded-3xl bg-black/60 border border-white/10 outline-none resize-none text-sm leading-relaxed focus:ring-2 focus:ring-white/20'
