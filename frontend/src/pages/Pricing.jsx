...
const plans = [
    {
        ...
        price: '₹0',
        credits: 100,
        description: "Perfect to explore Infinity Ai",
        features: [
...
const Pricing = () => {
            ...
            const options = {
                ...
                handler: async function (response) {
                    ...
                    const verify = await axios.post(
                        `${import.meta.env.VITE_SERVER_URL}/api/payment/verify`,response,
                        { withCredentials: true }
                    )
    ...
    return (
        <div className='relative min-h-screen overflow-hidden bg-[#050505] text-white px-6 pt-16 pb-24'>
            ...
            <button onClick={() => navigate("/")} className='relative z-10 mb-8 flex items-center gap-2 text-sm cursor-pointer text-zinc-400 hover:text-white transition'>
                <ArrowLeft size={16} />
                Back
            </button>
            <motion.div
            ...
            >
                <h1 className='text-4xl md:text-4xl font-bold mb-4'>Infinity Ai, Special Plans</h1>
                    ...
                    >
                        ...
                        <motion.button
                            ...
                            className={`w-full py-3 rounded-xl font-semibold transition ${p.popular ? "bg-indigo-500 hover:bg-indigo-600" :
                                "bg-white/10 hover:bg-white/20"} disabled:opacity-60 cursor-pointer`}
                        >
                            {p.button}
                        </motion.button>
                    </motion.div>
